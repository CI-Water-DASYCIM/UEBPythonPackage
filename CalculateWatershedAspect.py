# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# CalculateWatershedAspect.py
# Created on: 2013-01-14 09:17:55.00000
#   (generated by ArcGIS/ModelBuilder) and modified by Pabitra
# Description: Generates wateshed aspect netcdf file from the watershed  DEM raster file
# ---------------------------------------------------------------------------
...
if(os.path.isfile(InWS_DEM_File) == False):
    raise Exception("Specified watershed DEM file was not found:" + InWS_DEM_File)
    exit()
